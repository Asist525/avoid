...
def main():
    ...
    torch.save(trained_model.state_dict(), "avoidblurp_ddqn_reward_v0.pt")
    env.close()
    print("[INFO] Training finished. Model saved to avoidblurp_dqn_ddqn_basic_reward_v0.pt")
